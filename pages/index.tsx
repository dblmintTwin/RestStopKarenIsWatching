...
export default function Home() {
  ...
  return (
    ...
    <div
      className={`${geistSans.className} ${geistMono.className} flex min-h-screen items-center justify-center bg-sky-200 font-sans dark:bg-black`}
    >
          ...
          <div className="relative z-10 mx-auto max-w-6xl px-6 pt-20 pb-12 text-center">
            ...
            {status === "success" ? (
              <div className="mx-auto mt-10 max-w-md rounded-2xl border border-white/40 bg-white/95 p-5 shadow-xl">
                ...
                <p className="mt-1 text-sm text-[#11151d]/70">
                  We&apos;ll email you at launch and for major news.
                </p>
              </div>
            ) : (
              <form
              ...
              >
                ...
                {status === "error" && (
                  <p
                    role="alert"
                    className="mt-3 text-center text-sm font-semibold text-[#7a2e36]"
                  >
                    {errorMsg}
                  </p>
                )}

                <p className="mt-3 text-center text-xs font-medium text-[#11151d]/70">
                  Get notified when the game launches. No spam.
                </p>
              </form>
            )}
          </div>
